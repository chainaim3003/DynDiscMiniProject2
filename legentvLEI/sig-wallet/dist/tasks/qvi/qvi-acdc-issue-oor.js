...
const leLei = args[9];
const oorCredentialInfoPath = args[10];
...
const { said, issuer, issuee, acdc, anc, iss } = await issueCredential(client, qviAidName, registryName, oorSchemaSaid, personAid, oorCredData, credEdge, credRules);
