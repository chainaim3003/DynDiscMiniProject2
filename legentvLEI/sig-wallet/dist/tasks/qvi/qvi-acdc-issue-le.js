...
const credentialResult = await issueCredential(client, aidName, 'qvi-le-registry', LE_SCHEMA_SAID, leAid, credData, edgeData, rulesData);
...
const grantResult = await ipexGrantCredential(client, leAid, aidName, credentialResult.acdc, credentialResult.anc, credentialResult.iss);
